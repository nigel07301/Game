...
public class Game {
	...
	Font titleFont = new Font("Courier New", Font.PLAIN, 90);
	...
	public Game() {
		...
		titleNameLabel = new JLabel("Zelda");
	...
	public void createGameScreen() {
		...
		mainTextArea = new JTextArea("Nigel");
	...
	public void townGate() {
		position = "townGate";
		mainTextArea.setText("You are at the gate of the town. \nA a gaurd is standing in front of you. \n\nWhat will you do?");
	...
	public void ending() {
		...
		mainTextArea.setText("Guard: oh you kill that goblin!?\nThank you so much. You are a true Hero!\nWelcome to our town!\n\n<The END>");
